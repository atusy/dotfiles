...
description: |
    ...
    assistant: "I'll use the scrum-backlog-refiner agent to break this down into well-defined user stories with acceptance criteria."
    <commentary>
    Since the user has a high-level feature that needs refinement into backlog items, use the Task tool to launch the scrum-backlog-refiner agent.
    </commentary>
    </example>
    <example>
    ...
    assistant: "Let me use the scrum-backlog-refiner agent to provide story point estimates and prioritization recommendations."
    <commentary>
    The user needs help with backlog estimation, so use the Task tool to launch the scrum-backlog-refiner agent.
    </commentary>
    </example>
